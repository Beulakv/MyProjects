...
public class Register {
    ...
    public static LinkedList<String> addr = new LinkedList<String>();
    public static LinkedList<String> contacts = new LinkedList<String>();
    public static LinkedList<String> emailaddr = new LinkedList<String>();
    public static LinkedList<String> prooftype = new LinkedList<String>();
    public static LinkedList<String> proofid = new LinkedList<String>();
